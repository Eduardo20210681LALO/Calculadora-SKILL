...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Bienvenido, Este es una practica, Eduardo Hernandez';
...
const MultiplicacionIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let resultado = 0;
        resultado = numero1 * numero2;
        const speakOutput = `El resultado de la multiplicacion de ${numero1} * ${numero2} es igual a: ${resultado}`;
...
const DivisionIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let resultado = 0;
        resultado = numero1 / numero2;
        const speakOutput = `El resultado de la division de ${numero1} / ${numero2} es igual a: ${resultado}`;
...
const PotenciaIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `El resultado de ${numero1} elevado a la potencia de ${numero2} es igual a: ${resultado}`;
...
const LogaritmoIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `El logaritmo natural de ${numero} es igual a: ${resultado}`;
